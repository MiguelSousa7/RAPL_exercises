...
files_fib25 = {
    "Recursive -O2": "fibr_46_o2.csv",
    "Recursive -O0": "fibr_46_o0.csv",
    "Iterative -O2": "fibi_46_o2.csv",
    "Iterative -O0": "fibi_46_o0.csv",
}
...
df_fib25.to_csv(r"C:/Users/mikas/Desktop/Aulas/2_semestre/TDS/TP1/ex1/powercap_46/all_fib46.csv", index=False)
